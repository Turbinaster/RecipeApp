...
import androidx.compose.foundation.shape.RoundedCornerShape // Добавляем импорт для RoundedCornerShape
...
import androidx.compose.ui.draw.clip // Добавляем импорт для clip
